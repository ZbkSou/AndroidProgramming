...
//        setPositiveButton设置确认按钮具体位置与系统版本有关
        return new AlertDialog.Builder(getActivity()).setTitle("Date of crime").setView(view).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
